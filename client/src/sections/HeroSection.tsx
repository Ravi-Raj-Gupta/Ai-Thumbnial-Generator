...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.h1 className="text-5xl/17 md:text-6xl/21 font-medium max-w-5xl text-center"
            ...
            >
                ...
                <span className="md:whitespace-nowrap">
                    Thumbnails with <span className="move-gradient px-3 rounded-xl text-nowrap">ClickFrame</span>
                </span>
            </motion.h1>
