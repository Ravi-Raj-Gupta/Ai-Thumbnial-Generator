...
export default function PricingSection() {
    return (
        <div id="pricing" className="px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 overflow-hidden">
            <SectionTitle text1="Pricing" text2="Affordable plan" text3="Choose the plan that works best for you. Cancel anytime" />
